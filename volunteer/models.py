...
class Volunteer(models.Model):
    ...
    email_address = models.CharField(max_length=255, blank=True, null=True, verbose_name="البريد الالكتروني")
    ...
    status = models.CharField(max_length=50, null=True, blank=True, default="active", choices=Options.volunteer['status'])
